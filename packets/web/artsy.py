...
def main():
    ...
    webagent = Website('https://www.artsy.net',
                       ...
                       'ARTSY')
    artsy_newAndNoteworthy = Artsy(webagent)
    artsy_newAndNoteworthy.miner()
    # Blue chip artists.
    webagent = Website('https://www.artsy.net',
                       'https://www.artsy.net/collection/blue-chip-artists?additional_gene_ids%5B0%5D=painting&additional_gene_ids%5B1%5D=sculpture',
                       'ARTSY')
    artsy_blueChip = Artsy(webagent)
    artsy_blueChip.miner()


    # Trending and Emerging Artists
    webagent = Website('https://www.artsy.net',
                       'https://www.artsy.net/collection/trending-emerging-artists?additional_gene_ids%5B0%5D=painting&additional_gene_ids%5B1%5D=sculpture',
                       'ARTSY')
    artsy_trendingEmerging = Artsy(webagent)
    artsy_trendingEmerging.miner()
